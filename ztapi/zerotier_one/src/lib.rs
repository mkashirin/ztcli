...
pub mod types {
    ...
    pub struct NetworkDns {
        ...
        // a string meant to be `Domain` instead of an object, causing the
        // error to occur during deserialization.
    ...
    impl ::std::fmt::Display for NodeStatus {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            ...
            let primary_port = &settings.primary_port;
            let secondary_port = &settings.secondary_port;
